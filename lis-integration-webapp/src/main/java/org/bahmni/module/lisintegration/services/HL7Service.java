...
public class HL7Service {
     ...
     * @param providers      is the list {@link List} object of
     *                       {@link OpenMRSProvider)
     * @return if order is discontinued method returns cancelOrderMessage if not it
    ...
    public AbstractMessage createMessage(OpenMRSOrder order, List<Diagnosis> diagnosisList, Sample sample,
            OpenMRSPatient openMRSPatient, OpenMRSVisit visit, List<OpenMRSProvider> providers)
    ...
    private AbstractMessage cancelOrderMessage(OpenMRSOrder order, Sample sample, OpenMRSPatient openMRSPatient,
            OpenMRSVisit visit, List<OpenMRSProvider> providers) throws DataTypeException, IOException {
